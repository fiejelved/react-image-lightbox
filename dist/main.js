        ...
        (function(global) {
            ...
            var ReactImageLightbox = function(_Component) {
                ...
                return _inherits(ReactImageLightbox, _Component), _createClass(ReactImageLightbox, null, [ {
                    ...
                    key: "getTransform",
                    value: function(_ref) {
                        var _ref$x = _ref.x, x = void 0 === _ref$x ? null : _ref$x, _ref$y = _ref.y, y = void 0 === _ref$y ? null : _ref$y, _ref$zoom = _ref.zoom, zoom = void 0 === _ref$zoom ? null : _ref$zoom, _ref$rotate = _ref.rotate, rotate = void 0 === _ref$rotate ? 0 : _ref$rotate, transforms = [], isOldIE = ieVersion < 10;
                        (0, _util.getWindowWidth)();
                        ...
                        0 !== rotate && transforms.push("rotate(" + rotate + "deg)"), _defineProperty({}, isOldIE ? "msTransform" : "transform", 0 === transforms.length ? "none" : transforms.join(" "));
                    }
                }, {
                    key: "loadStyles",
                    value: function() {
                    ...
                    value: function(angle) {
                        this.setState({
                            rotate: this.state.rotate + angle
                        }), this.props.onImageRotate(angle), console.log("rotate");
                    }
                }, {
                    key: "changeZoom",
                    ...
                    value: function(event) {
                        ...
                        if (event.stopPropagation(), this.isAnimating()) return rotateLeftButtonHandler = noop, 
                        void (rotateRightButtonHandler = noop);
                    ...
                    value: function(event) {
                        if (event.preventDefault(), Math.abs(event.deltaY) >= Math.abs(event.deltaX)) {
                            // If the vertical scroll amount was large enough, perform a zoom
                            if (event.stopPropagation(), Math.abs(event.deltaY) < _constant.WHEEL_MOVE_Y_THRESHOLD) return;
                    ...
                    value: function() {
                        var _this8 = this;
                        this.pointerList = this.pointerList.filter(function(_ref4) {
                            return _ref4.source === _this8.eventsSource;
                        });
                    }
                }, {
                    key: "handleMouseDown",
                    ...
                    value: function(_ref6) {
                        var clientX = _ref6.x, clientY = _ref6.y, newOffsetX = this.moveStartX - clientX + this.moveStartOffsetX, newOffsetY = this.moveStartY - clientY + this.moveStartOffsetY;
                    ...
                    value: function(_ref8) {
                        var clientX = _ref8.x, clientY = _ref8.y;
                        this.swipeEndX = clientX, this.swipeEndY = clientY;
                    }
                }, {
                    key: "handleSwipeEnd",
                    ...
                    value: function() {
                        var _ref11 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.pinchTouchList, _ref12 = _slicedToArray(_ref11, 2), a = _ref12[0], b = _ref12[1];
                        return {
                            x: a.x - (a.x - b.x) / 2,
                            y: a.y - (a.y - b.y) / 2
                        };
                    ...
                    value: function(pointerList) {
                        this.props.enableZoom && (this.currentAction = _constant.ACTION_PINCH, this.pinchTouchList = pointerList.map(function(_ref13) {
                            return {
                                id: _ref13.id,
                                x: _ref13.x,
                                y: _ref13.y
                    ...
                    value: function() {
                        ...
                        var rotateLeftButtonClasses = [ styles.toolbarItemChild, styles.builtinButton, styles.rotateLeftButton ], rotateRightButtonClasses = [ styles.toolbarItemChild, styles.builtinButton, styles.rotateRightButton ], rotateLeftButtonHandler = function() {
                            return _this16.changeRotation(-90);
                        ...
                        })), enableRotate && _react2.default.createElement("li", {
                            className: "rol-toolbar__item " + styles.toolbarItem
                        }, _react2.default.createElement("button", {
 ...
 */
    ...
    function(module, exports, __webpack_require__) {
        ...
        exports.locals = {
            ...
            rotateLeftButton: "ril__rotateLeftButton",
            rotateRightButton: "ril__rotateRightButton",
